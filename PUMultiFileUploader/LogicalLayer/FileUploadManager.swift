...
class FileUploadManager : NSObject {
    ...
    func uploadFile(mimeType:String = "image/png",fileName:String = "\(ProcessInfo().globallyUniqueString).png",completionHandler: @escaping (Data , [String:Any]?, Error?, Bool) -> Void)
    {
